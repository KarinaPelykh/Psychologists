...
export const Home = () => {
  return (
    <section
      className="min-w-fit
    min-h-screen  desktop:flex  "
    >
      <div className=" tablet:w-[595px] tablet:flex tablet:mx-[auto] tablet:flex-col  desktop:mr-[125px] desktop:pt-[126px]">
        <h1 className="font-semibold leading-[1.02] text-[50px] mb-[24px] tablet:text-[80px]   tablet:tracking-[0.02rem] tablet:mb-[20px]">
          The road to the <span className="text-[#FC832C]">depths</span> of the
          human soul
        </h1>
        <p className="text-[ #191a15] font-medium text-base leading-[1.33]  tracking-[0.02rem] tablet:w-[460px] 	 tablet:mb-[40px]">
          We help you to reveal your potential, overcome challenges and find a
          guide in your own life with the help of our experienced psychologists.
        </p>
        <Button prop="Get started" className="w-fit" />
      </div>
      <div className="relative  mobil:w-[280px] tablet:w-[464px]   tablet:flex tablet:mx-[auto] tablet:flex-col  desktop:pt-[78px] ">
        ...
        <div className=" w-[280px] h-[auto] bottom-[80px]  left-[-10px] absolute tablet:bottom-[55px] tablet:left-[270px] bg-[#FC832C] tablet:w-[311px] tablet:h-[118px] rounded-[20px] flex justify-center  items-center desktop:left-[-110px]">
