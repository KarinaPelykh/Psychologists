...
export const BurgerMenu = ({ isOpenMenu, toggleMenu }: Prop) => {
  ...
  return (
    <>
      {isOpenMenu && (
        <div className="w-[100vw] h-[100vh] fixed top-0 left-0  z-40">
          <div className="w-[100vw] h-[100vh] bg-gradient-to-br from-white to-[#fe6c04]   absolute top-0 left-0 p-[30px] flex flex-col items-center justify-center">
